...
class AlbumSerializer(RelatedToUserModelSerializer):
    ...
    class Meta:
        model = Album
        fields = (
        'id', 'title', 'creation_date', 'total_photos', 'total_likes', 'private', 'user_id', 'username', 'thumbnail')
...
class AlbumDetailSerializer(RelatedToUserModelSerializer):
    ...
    class Meta:
        model = Album
        fields = (
        'id', 'title', 'creation_date', 'photos', 'total_photos', 'total_likes', 'private', 'user_id', 'username')
